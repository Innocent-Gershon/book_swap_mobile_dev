...
mixin _$BookEntity {
  ...
  String? get swapFor => throw _privateConstructorUsedError;
...
class _$BookEntityImpl implements _BookEntity {
  ...
  @override
  String toString() {
    return 'BookEntity(id: $id, title: $title, author: $author, description: $description, condition: $condition, ownerId: $ownerId, imageUrl: $imageUrl, isAvailable: $isAvailable, createdAt: $createdAt, updatedAt: $updatedAt, postedDate: $postedDate, swapFor: $swapFor)';
  }
...
abstract class _BookEntity implements BookEntity {
  const factory _BookEntity(
      ...
      final String? swapFor}) = _$BookEntityImpl;
