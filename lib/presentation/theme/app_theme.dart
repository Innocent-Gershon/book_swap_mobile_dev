...
class AppTheme {
  ...
  static ThemeData get darkTheme => ThemeData(
    ...
    primarySwatch: MaterialColor(0xFF90CAF9, {
      50: AppColors.darkPrimary.withValues(alpha: 0.1),
      100: AppColors.darkPrimary.withValues(alpha: 0.2),
      200: AppColors.darkPrimary.withValues(alpha: 0.3),
      300: AppColors.darkPrimary.withValues(alpha: 0.4),
      400: AppColors.darkPrimary.withValues(alpha: 0.5),
      500: AppColors.darkPrimary,
      600: AppColors.darkPrimary.withValues(alpha: 0.7),
      700: AppColors.darkPrimary.withValues(alpha: 0.8),
      800: AppColors.darkPrimary.withValues(alpha: 0.9),
